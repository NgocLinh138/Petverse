...
namespace Persistence.Migrations
{
    ...
    [Migration("20241123121623_CompositeIndex_StoreProcedure")]
    partial class CompositeIndex_StoreProcedure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AppointmentRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentRate", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.CenterBreedImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CenterBreedImage", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.JunctionEntity.SpeciesPlace", b =>
                {
                    ...
                    b.HasKey("PlaceId", "SpeciesId");

                    b.HasIndex("SpeciesId");

                    b.ToTable("SpeciesPlace", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.JunctionEntity.VaccineRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ReportImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AppointmentRate", b =>
                {
                    b.HasOne("Domain.Entities.Appointment", "Appointment")
                        .WithOne("AppointmentRate")
                        .HasForeignKey("Domain.Entities.AppointmentRate", "AppointmentId")
            ...
            modelBuilder.Entity("Domain.Entities.CenterBreed", b =>
                {
                    ...
                    b.Navigation("CenterBreedImages");
                });
