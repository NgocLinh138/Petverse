...
namespace Persistence.Migrations
{
    ...
    [Migration("20241027090202_ChangeTypeOfFieldAgeInPetTable")]
    partial class ChangeTypeOfFieldAgeInPetTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DoctorRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DoctorRate", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.DoctorAppointment", b =>
                {
                    b.HasBaseType("Domain.Entities.Appointment");
            ...
            modelBuilder.Entity("Domain.Entities.Doctor", b =>
                {
                    b.HasOne("Domain.Entities.Application", "Application")
                        .WithOne("Doctor")
                        .HasForeignKey("Domain.Entities.Doctor", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.DoctorAppointment", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Appointment", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.DoctorAppointment", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Pet", b =>
                {
                    b.Navigation("BreedingAppointments");
