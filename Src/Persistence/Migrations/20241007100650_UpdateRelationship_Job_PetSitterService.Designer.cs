...
namespace Persistence.Migrations
{
    ...
    [Migration("20241007100650_UpdateRelationship_Job_PetSitterService")]
    partial class UpdateRelationship_Job_PetSitterService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.JunctionEntity.PetSitterServiceType", b =>
                {
                    b.Property<int>("PetSitterServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PetSitterServiceId", "PetTypeId");

                    b.HasIndex("PetTypeId");

                    b.ToTable("PetSitterServiceType", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Job", b =>
                {
                    b.HasOne("Domain.Entities.PetSitterService", "PetSitterService")
                        .WithOne("Job")
                        .HasForeignKey("Domain.Entities.Job", "PetSitterServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.JunctionEntity.PetSitterServiceType", b =>
                {
                    b.HasOne("Domain.Entities.PetSitterService", "PetSitterService")
                        .WithMany("PetSitterServiceTypes")
            ...
            modelBuilder.Entity("Domain.Entities.PetSitterService", b =>
                {
                    ...
                    b.Navigation("PetSitterServiceTypes");
                });
