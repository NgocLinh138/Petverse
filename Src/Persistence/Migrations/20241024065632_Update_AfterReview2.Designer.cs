...
namespace Persistence.Migrations
{
    ...
    [Migration("20241024065632_Update_AfterReview2")]
    partial class Update_AfterReview2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.JunctionEntity.JobSpecies", b =>
                {
                    ...
                    b.ToTable("JobSpecies", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.PetCenter", b =>
                {
                    b.HasOne("Domain.Entities.Identity.AppUser", "User")
                        .WithOne("PetCenter")
                        .HasForeignKey("Domain.Entities.PetCenter", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
